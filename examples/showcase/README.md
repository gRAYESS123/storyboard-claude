...
| **`scene-3d-beauty.html`** / `scene-3d-beauty.mp4` | **Beautiful 3D** — full-bleed WebGL scenes: a 14,000-star spiral galaxy, a synthwave highway with streaming car lights, a ringed planet with atmosphere, and a warp-speed CTA. Uses `data-res` to stay smooth at full screen. |
